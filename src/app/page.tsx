...
export default function Home() {
  ...
  const [restaurant, setRestaurant] = useState<RestaurantData | null | 'loading'>('loading')
  ...
  // Still detecting subdomain — show nothing (prevents flash)
        ...
        <div className="relative max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center py-4">
          ...
          <div>
            ...
            <div style={{ opacity: heroLoaded ? 1 : 0, transform: heroLoaded ? 'translateY(0)' : 'translateY(16px)', transition: 'all 0.8s ease 530ms' }}
              ...
              <Link href="/onboard"
                className="flex items-center gap-2 bg-blue-800 text-white font-semibold px-7 py-4 rounded-xl text-base hover:bg-blue-900 transition-all hover:scale-[1.03] shadow-lg shadow-blue-200/60">
                Get Started Free <ArrowRight className="w-5 h-5" />
              </Link>
              <a href="#features"
                className="flex items-center gap-2 text-gray-500 font-semibold px-7 py-4 rounded-xl text-base hover:text-gray-900 transition-colors">
        ...
        <div className="max-w-5xl mx-auto">
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-500">Four simple steps to digitize your restaurant</p>
            </div>
          </Reveal>
            ...
            {STEPS.map((s, i) => (
              <Reveal key={s.n} delay={i * 120}>
                <div className="text-center relative">
                  ...
                  <div className="w-14 h-14 bg-blue-800 text-white rounded-full flex items-center justify-center text-sm font-bold mx-auto mb-5 relative z-10 shadow-lg shadow-blue-100">
                    {s.n}
                  </div>
